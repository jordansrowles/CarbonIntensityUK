...
namespace CarbonIntensityUK.RegionalIntensity
{
    public static class RegionalIntensity
    {
        ...
        public static async Task<List<RegionalIdIntensityResponse>> Get(IntensityUriOption option, DateTime from, string postcode)
        {
            var json = await ApiClient.QueryAsync($"https://api.carbonintensity.org.uk/regional/itensity/{ApiClient.FormatDateTime(from)}/{option.ToString()}/postcode/{postcode}");
            return ApiClient.AttemptConvert<List<RegionalIdIntensityResponse>>(json);
        }
        ...
        /// <returns>RegionalId schema</returns>
        public static async Task<List<RegionalIdIntensityResponse>> Get(IntensityUriOption option, DateTime from, RegionId region)
        {
            var json = await ApiClient.QueryAsync($"https://api.carbonintensity.org.uk/regional/itensity/{ApiClient.FormatDateTime(from)}/{option.ToString()}/regionid/{(int)region}");
            return ApiClient.AttemptConvert<List<RegionalIdIntensityResponse>>(json);
        }
        ...
        /// <returns>RegionalId schema</returns>
        public static async Task<List<RegionalIdIntensityResponse>> Get(DateTime from, DateTime to, string postcode)
        {
            var json = await ApiClient.QueryAsync($"https://api.carbonintensity.org.uk/regional/intensity/{ApiClient.FormatDateTime(from)}/{ApiClient.FormatDateTime(to)}/regionid/{postcode}");
            return ApiClient.AttemptConvert<List<RegionalIdIntensityResponse>>(json);
        }
        ...
        /// <returns>RegionalId schema</returns>
        public static async Task<List<RegionalIdIntensityResponse>> Get(DateTime from, DateTime to, RegionId regionId)
        {
